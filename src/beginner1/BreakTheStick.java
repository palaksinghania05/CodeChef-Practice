...
1. If the inital length (N) of the stick was even and the target length (X) is also even, we are left with
...
2. If the inital length (N) of the stick was even and the target length (X) is odd, we are left with two
 sticks of odd length, namely X and N-X. Since the two sticks have the same parity, we can stop breaking
 the sticks further down.

3. If the inital length (N) of the stick was odd and the target length (X) is also odd, we are left with
...
4. If the inital length (N) of the stick was odd and the target length (X) is even, we are left with one
